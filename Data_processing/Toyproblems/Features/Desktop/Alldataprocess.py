...
# # Plot measured memory data for each method
# plot_method(axes[1, 1], cp_memory_meas, 'Measured memory CP', colors, compression_ratios, features, ylim=ylim_memory)
# plot_method(axes[1, 2], tucker_memory_meas, 'Measured memory Tucker', colors, compression_ratios, features, ylim=ylim_memory)
# plot_method(axes[1, 1], tt_memory_meas, 'Measured memory TT', colors, compression_ratios, features, ylim=ylim_memory)
