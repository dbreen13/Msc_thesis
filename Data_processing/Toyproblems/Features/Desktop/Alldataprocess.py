...
#%%Combine all datasets to form one large set
...
# Create the new index based on the specified format, to make sure it is the same as the log files
new_index = [
